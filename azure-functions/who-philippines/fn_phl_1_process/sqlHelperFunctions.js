...
const fieldDataTypeMapping = {
    ...
    'death_date': sql.Date,
    'recovery_date': sql.Date,
    'hospitalization': sql.Bit,
    'residency_sub_national_1_name': sql.VarChar(100),
    'residency_sub_national_2_name': sql.VarChar(100),
    'residency_sub_national_3_name': sql.VarChar(100),
    'residency_sub_national_3_code': sql.VarChar(20),
...
const storedProcedure = "processed.csp_case_details_upsert_phl_1"
