...
const fieldDataTypeMapping = {
    ...
    'exposure_history_post_onset': sql.VarChar(100),
    'test_result_confirmation_date': sql.Date,
    'linked_to_cluster_exposure_to_known_case': sql.Bit,
    'symptom_onset_date': sql.Date,
    'symptoms_present_at_presentation_testing': sql.Bit,
...
const storedProcedure = "processed.csp_case_details_upsert_sg_2"
